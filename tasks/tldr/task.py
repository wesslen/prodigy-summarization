...
from spacy_llm.ty import FewshotExample, TaskResponseParser
from spacy_llm.tasks.builtin_task import BuiltinTask
from spacy_llm.tasks.templates import read_template

DEFAULT_TLDR_TEMPLATE_V1 = read_template("tldr.v1")


class TldrTask(BuiltinTask):
    def __init__(
        self,
